              ...
              {orders.map((order) => {
                return (
                  ...
                  >
                    ...
                    <td>
                      <button
                        className="bg-gray-700 text-white p-2 rounded-lg cursor-pointer ml-2"
                        onClick={() => {
            ...
            <div className="fixed bg-[#00000070] w-full h-full top-0 left-0 flex justify-center items-center">
              <div className="w-[600px] max-w-[600px] h-[600px] max-h-[600px] bg-white relative">
                <div className="w-full h-[150px] ">
                  <h1 className="text-sm font-bold mb-1 ml-2">
                ...
                <button
                  className="w-[40px] h-[40px] absolute top-[-20px] right-[-20px] rounded-full bg-white shadow shadow-black flex justify-center items-center cursor-pointer"
                  onClick={() => {
